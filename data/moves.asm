...
endm
	...
	move MEGA_PUNCH,   NO_ADDITIONAL_EFFECT,        85, NORMAL,    90, 20
	...
	move RAZOR_WIND,   CHARGE_EFFECT,              160, NORMAL,   100, 10
	...
	move SLAM,         NO_ADDITIONAL_EFFECT,       100, NORMAL,    75, 20
	...
	move ACID,         SPECIAL_DOWN_SIDE_EFFECT,    55, POISON,   100, 30
	...
	move SUBMISSION,   RECOIL_EFFECT,              100, FIGHTING,  90, 25
	...
	move STRING_SHOT,  SPEED_DOWN2_EFFECT,           0, NORMAL,    95, 40
	...
	move PSYCHIC_M,    CONFUSION_SIDE_EFFECT,       90, PSYCHIC,  100, 10
	...
	move SELFDESTRUCT, EXPLODE_EFFECT,             120, NORMAL,   100,  5
	move EGG_BOMB,     NO_ADDITIONAL_EFFECT,       120, NORMAL,   100, 10
	...
	move SPIKE_CANNON, TWO_TO_FIVE_ATTACKS_EFFECT,  25, WATER,    100, 30
	...
	move BARRAGE,      TWO_TO_FIVE_ATTACKS_EFFECT,  25, GRASS,    100, 30
	...
	move DIZZY_PUNCH,  CONFUSION_EFFECT,           100, NORMAL,    50,  5
