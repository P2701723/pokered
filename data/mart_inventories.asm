...
VermilionMartText1:: ; 2461 (0:2461)
	...
	db PARLYZ_HEAL,AWAKENING,ICE_HEAL,ESCAPE_ROPE,REPEL,$FF

; Lavender
LavenderMartText1:: ; 246a (0:246a)
	db $FE,10,GREAT_BALL,SUPER_POTION,REVIVE,ANTIDOTE,PARLYZ_HEAL
	db BURN_HEAL,ICE_HEAL,ESCAPE_ROPE,SUPER_REPEL,ETHER,$FF

; Celadon Dept. Store 2F (1)
CeladonMart2Text1:: ; 2476 (0:2476)
	db $FE,10,POTION,SUPER_POTION,HYPER_POTION,MAX_POTION
	db REVIVE,REPEL,SUPER_REPEL,MAX_REPEL,ETHER,ELIXER,$FF
...
CeladonMart5Text3:: ; 2496 (0:2496)
	db $FE,7,X_ATTACK,X_DEFEND,X_SPEED,X_SPECIAL,X_ACCURACY
	db DIRE_HIT,GUARD_SPEC_,$FF
...
IndigoPlateauLobbyText4:: ; 24cc (0:24cc)
	db $FE,16,GREAT_BALL,ULTRA_BALL,HYPER_POTION,MAX_POTION,FULL_RESTORE
	db REVIVE,MAX_REVIVE,FULL_HEAL,MAX_ETHER,MAX_ELIXER
